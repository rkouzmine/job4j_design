...
class ArgsNameTest {
    ...
    @Test
    void whenAbsenceOfASymbolIsEqualTo() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-key:value", "-encoding=UTF-8"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
    ...
    @Test
    void whenAbsenceOfAMinusSymbol() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"key=value", "-encoding=UTF-8"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
