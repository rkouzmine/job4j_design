...
fetch last from cursor_products; -- 20

MOVE BACKWARD 6 FROM cursor_products;
FETCH FORWARD 1 FROM cursor_products; -- 15

MOVE ABSOLUTE 6 FROM cursor_products;
FETCH FORWARD  1 FROM cursor_products; -- 7

MOVE BACKWARD 4 FROM cursor_products;
fetch BACKWARD 1 from cursor_products; -- 2
